...
bool QDataModule::copyDeviceWindowAsMirror(long srcID, bool bHorizontal, QVector<int>& winIDs, QVector<int>& groupIDs)
{
    return m_pDeviceListWidget->copyDeviceWindowAsMirror(srcID, bHorizontal, winIDs, groupIDs);
}
