...
public:
	...
	Solid * getDifference(bool bShowSecondObj);
	VectorSet* getFaceSplits();

private:
	
	Solid * composeSolid(int faceStatus1, int faceStatus2, int faceStatus3, bool showSecondObj = true);
