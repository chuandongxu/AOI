...
public:
	...
	void setXYSize(int xAxisLen, int yAxisLen, int xOffset,int yOffset);
	...
	void getAxisXLimit(int& nMaxValue, int& nMinValue);
	void getAxisYLimit(int& nMaxValue, int& nMinValue);
...
private:
	...
	double AXES_LEN_X;
	double AXES_LEN_Y;
	double AXES_LEN_OFFSET_X;
	double AXES_LEN_OFFSET_Y;
	double AXES_LEN_Z;
